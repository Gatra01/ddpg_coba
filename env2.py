...
class GameState:
    ...
    def step(self,power,channel_gain,next_channel_gain):
        ...
        for i in range(self.nodes):
            data_rate_constraint.append(150*max(self.step_function(0.51-data_rate[i])),0)
        ...
        reward = EE -  150*max(self.step_function(total_daya-self.p_max),0)-np.sum(data_rate_constraint)
