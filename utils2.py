...
def evaluate_policy(channel_gain,state, env, agent,episode,turns = 3):
    env = GameState(5,3)   
    total_scores = 0
    total_data_rate = 0
    total_power = 0
    ...
    for j in range(turns):
        ...
        while not done:
            ...
            s_next, r, dw, tr, info,EE,rate = env.step(a,channel_gain,next_channel_gain,episode)
